class App {
    ...
    start() {
        ...
        //esta função garantirá que a função sempre será diferente de 3
        this.printAndExit()
    }
    ...
    enrollSpaceship() {
        ...
        let crewQuantity = prompt("Qual a quantidadede de tripulantes?")
    ...
    showInitialMenu() {
        ...
        while(!["1", "2", "3"].includes/*includes incluira chosenOption*/(chosenOption)) {
